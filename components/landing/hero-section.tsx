      ...
      <div className="relative mx-auto max-w-5xl text-center">
        ...
        >
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-border bg-card px-4 py-1.5 text-sm text-muted-foreground">
            ...
            <span>The modern way to manage events</span>
          </div>
        </motion.div>
        ...
        >
          From intimate workshops to large conferences — plan, promote, and
          manage your events with a platform designed for organizers who care
          about the details.
        </motion.p>
